...
-- Phase 7: confirm-as-interrupt payload (staged artifacts + the human
-- approve/reject decision) for a run paused at status 'waiting_user'.
ALTER TABLE agent_runtime_runs ADD COLUMN IF NOT EXISTS interrupt JSONB;
